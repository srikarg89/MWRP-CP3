...
std::pair<int, int> get_multi_tsp_f_and_focal_value(const DisjointGraph& disjoint_graph, const std::vector<int>& agent_costs, FocalMethod focal_method, bool optimize_focal) {
